    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Yönetici'), ('seller', 'Satıcı/Müteahhit'), ('buyer', 'Alıcı')], default='buyer', max_length=20, verbose_name='Kullanıcı Tipi')),
            ...
            options={
                ...
                'db_table': 'users',
                'indexes': [models.Index(fields=['email'], name='users_email_4b85f2_idx'), models.Index(fields=['user_type'], name='users_user_ty_578f8f_idx')],
            },
            managers=[
